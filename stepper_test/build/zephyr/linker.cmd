...
MEMORY
    ...
    BACKUP_SRAM ( rw ) : ORIGIN = (947912704), LENGTH = (4096) EXTMEM ( rw ) : ORIGIN = (2415919104), LENGTH = (268435456) SRAM1 ( rw ) : ORIGIN = (604241920), LENGTH = (393216) SRAM2 ( rw ) : ORIGIN = (604635136), LENGTH = (393216) SRAM3 ( rw ) : ORIGIN = (805306368), LENGTH = (65536) SRAM4 ( rw ) : ORIGIN = (805371904), LENGTH = (65536) SRAM5 ( rw ) : ORIGIN = (939524096), LENGTH = (32768) DTCM ( rw ) : ORIGIN = (536870912), LENGTH = (131072) ITCM ( rw ) : ORIGIN = (0), LENGTH = (65536) EXTMEM2 ( rw ) : ORIGIN = (1879048192), LENGTH = (268435456)
